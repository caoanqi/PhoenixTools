...
public class CommonUtils {
    ...
    public static String getIMEI(Context context) {
        if (null == context) {
            context = PhoenixApp.getInstance();
        }
        String imei = "";
        try {
    ...
    public static String getAppManifestApplicationMetaData(String applicationMetaDataName) {
        try {
            ApplicationInfo appInfo = PhoenixApp.getInstance().getPackageManager()
                    .getApplicationInfo(PhoenixApp.getInstance().getPackageName(), PackageManager.GET_META_DATA);
